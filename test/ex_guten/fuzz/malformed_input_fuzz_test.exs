defmodule ExGuten.Fuzz.MalformedInputFuzzTest do
  use ExUnit.Case
  ...
  test "XML parser and renderer return errors across malformed XML corpus" do
    Enum.each(1..24, fn idx ->
      ...
      capture_log(fn ->
        ...
        assert {:error, :invalid_xml} = Template.render_xml_document(ExGuten.new(), malformed_xml)
      end)
    end)
  end

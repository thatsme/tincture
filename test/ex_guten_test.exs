defmodule ExGutenTest do
  ...
  test "add_page/1 creates a new current page with isolated operations" do
    pdf =
      ExGuten.new()
      |> ExGuten.text_at(10, 700, "page one")
      |> ExGuten.add_page()
      |> ExGuten.text_at(10, 700, "page two")
  ...
  test "set_page/2 switches current page and preserves per-page operations" do
    pdf =
      ExGuten.new()
      |> ExGuten.text_at(10, 700, "one")
      |> ExGuten.add_page()
      |> ExGuten.text_at(10, 700, "two")
      |> ExGuten.set_page(1)
      |> ExGuten.text_at(20, 680, "one-more")
    ...
    pdf_page_two = ExGuten.set_page(pdf, 2)
  ...
  test "register_ttf_font/3 embeds a TrueType font and allows set_font/3" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoTTF", path)
      |> ExGuten.set_font("DemoTTF", 14)
      |> ExGuten.text_at(50, 700, "Hello TTF")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 supports opt-in baseline subset mode" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoSubset", path, subset: :ascii_basic)
      |> ExGuten.set_font("DemoSubset", 14)
      |> ExGuten.text_at(50, 700, "Subset text")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 ascii_basic subset uses Type0/CID objects for non-ASCII text runs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoSubsetUnicode", path, subset: :ascii_basic)
      |> ExGuten.set_font("DemoSubsetUnicode", 14)
      |> ExGuten.text_at(50, 700, "Snowman ☃")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 supports used-text subset range mode" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUsedSubset", path, subset: :used_text)
      |> ExGuten.set_font("DemoUsedSubset", 14)
      |> ExGuten.text_at(50, 700, "AZ")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset includes space/punctuation ranges" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUsedSubsetRange", path, subset: :used_text)
      |> ExGuten.set_font("DemoUsedSubsetRange", 14)
      |> ExGuten.text_at(50, 700, "A Z!")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset uses Type0/CID objects for non-ASCII text runs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUsedSubsetUnicode", path, subset: :used_text)
      |> ExGuten.set_font("DemoUsedSubsetUnicode", 14)
      |> ExGuten.text_at(50, 700, "Snowman ☃")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 uses parsed TTF widths for used-text subset ranges" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoMappedWidths", path, subset: :used_text)
      |> ExGuten.set_font("DemoMappedWidths", 14)
      |> ExGuten.text_at(50, 700, "AB")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset emits smaller FontFile2 stream when loca/glyf subset is possible" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoSubsetProgram", path, subset: :used_text)
      |> ExGuten.set_font("DemoSubsetProgram", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset emits 4-byte aligned sfnt table offsets" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoSubsetAligned", path, subset: :used_text)
      |> ExGuten.set_font("DemoSubsetAligned", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset emits valid sfnt checkSumAdjustment" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoSubsetChecksum", path, subset: :used_text)
      |> ExGuten.set_font("DemoSubsetChecksum", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset keeps component glyph programs for composite glyphs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoCompositeSubset", path, subset: :used_text)
      |> ExGuten.set_font("DemoCompositeSubset", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset falls back to full FontFile2 stream when composite glyph references an invalid component glyph ID" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoCompositeSubsetInvalidComponent", path,
        subset: :used_text
      )
      |> ExGuten.set_font("DemoCompositeSubsetInvalidComponent", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 used-text subset falls back to full FontFile2 stream when composite glyph has malformed component records" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoCompositeSubsetMalformedComponent", path,
        subset: :used_text
      )
      |> ExGuten.set_font("DemoCompositeSubsetMalformedComponent", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 keeps full FontFile2 stream length when subset mode is :none" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoFullProgram", path, subset: :none)
      |> ExGuten.set_font("DemoFullProgram", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor FontBBox from parsed glyf bounds when available" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoGlyphBBox", path)
      |> ExGuten.set_font("DemoGlyphBBox", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor FontBBox from head table when glyf bounds are absent" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoHeadBBox", path)
      |> ExGuten.set_font("DemoHeadBBox", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor ascent/descent/cap height from parsed metrics" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoVerticalMetrics", path)
      |> ExGuten.set_font("DemoVerticalMetrics", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor Leading from parsed line-gap metrics" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoLeadingMetrics", path)
      |> ExGuten.set_font("DemoLeadingMetrics", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 falls back to OS/2 win ascent/descent when typo and hhea metrics are zero" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoWinFallbackMetrics", path)
      |> ExGuten.set_font("DemoWinFallbackMetrics", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor StemV from parsed OS/2 weight class when present" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoWeightStemV", path)
      |> ExGuten.set_font("DemoWeightStemV", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor StemH from parsed OS/2 weight class fallback" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoWeightStemH", path)
      |> ExGuten.set_font("DemoWeightStemH", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor FontWeight from parsed OS/2 weight class" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoFontWeight", path)
      |> ExGuten.set_font("DemoFontWeight", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor StemV from parsed CFF StdVW when OS/2 weight is unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFStemV", path)
      |> ExGuten.set_font("DemoCFFStemV", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 falls back descriptor StemV to parsed CFF StdHW when StdVW and OS/2 weight are unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFStemHFallback", path)
      |> ExGuten.set_font("DemoCFFStemHFallback", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor StemH from parsed CFF StdHW when present" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFStemH", path)
      |> ExGuten.set_font("DemoCFFStemH", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor force-bold flag from parsed CFF Private ForceBold metadata" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFForceBold", path)
      |> ExGuten.set_font("DemoCFFForceBold", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontWeight from parsed CFF weight metadata when OS/2 weight is unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFFontWeight", path)
      |> ExGuten.set_font("DemoCFFFontWeight", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontWeight from parsed CFF standard SID weight metadata when OS/2 weight is unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFStandardSIDFontWeight", path)
      |> ExGuten.set_font("DemoCFFStandardSIDFontWeight", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontWeight from numeric parsed CFF weight metadata when OS/2 weight is unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFNumericFontWeight", path)
      |> ExGuten.set_font("DemoCFFNumericFontWeight", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontWeight from hyphenated parsed CFF weight metadata when OS/2 weight is unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFHyphenFontWeight", path)
      |> ExGuten.set_font("DemoCFFHyphenFontWeight", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor FontStretch from parsed OS/2 width class" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoFontStretch", path)
      |> ExGuten.set_font("DemoFontStretch", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor FSType from parsed OS/2 metadata" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoFSType", path)
      |> ExGuten.set_font("DemoFSType", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 can enforce OS/2 embedding permissions for restricted-license fonts" do
    ...
    assert_raise ArgumentError, ~r/font embedding restricted by OS\/2 fsType \(2\)/, fn ->
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoRestrictedEmbedding", path,
  ...
  test "register_ttf_font/4 can enforce OS/2 no-subsetting permissions for subset modes" do
    ...
    assert_raise ArgumentError, ~r/font disallows subsetting via OS\/2 fsType \(256\)/, fn ->
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoNoSubsetting", path,
        subset: :used_text,
        enforce_embedding_permissions: true
      )
    end
  ...
  test "register_ttf_font/4 can enforce OS/2 bitmap-only embedding permissions" do
    ...
    assert_raise ArgumentError,
                 ...
                 fn ->
                   ExGuten.new()
                   |> ExGuten.register_ttf_font("DemoBitmapOnlyEmbedding", path,
                     enforce_embedding_permissions: true
                   )
                 end
  ...
  test "register_ttf_font/4 enforcement reports combined OS/2 bitmap-only and no-subsetting flags" do
    ...
    assert_raise ArgumentError,
                 ...
                 fn ->
                   ExGuten.new()
                   |> ExGuten.register_ttf_font("DemoCombinedFlagsEmbedding", path,
                     subset: :used_text,
                     enforce_embedding_permissions: true
                   )
                 end
  ...
  test "register_ttf_font/3 warns on restricted OS/2 embedding permissions when enforcement is disabled" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_ttf_font("DemoRestrictedWarn", path)
      end)
  ...
  test "register_ttf_font/4 warns on OS/2 no-subsetting permissions when enforcement is disabled" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_ttf_font("DemoNoSubsetWarn", path, subset: :used_text)
      end)
  ...
  test "register_ttf_font/4 warning reports combined OS/2 bitmap-only and no-subsetting flags" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_ttf_font("DemoCombinedFlagsWarn", path, subset: :used_text)
      end)
  ...
  test "register_otf_font/4 can enforce OS/2 embedding permissions for restricted-license fonts" do
    ...
    assert_raise ArgumentError, ~r/font embedding restricted by OS\/2 fsType \(2\)/, fn ->
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFRestrictedEmbedding", path,
        enforce_embedding_permissions: true
      )
    end
  ...
  test "register_otf_font/4 can enforce OS/2 no-subsetting permissions for subset modes" do
    ...
    assert_raise ArgumentError, ~r/font disallows subsetting via OS\/2 fsType \(256\)/, fn ->
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFNoSubsetting", path,
        subset: :used_text,
        enforce_embedding_permissions: true
      )
    end
  ...
  test "register_otf_font/4 can enforce OS/2 bitmap-only embedding permissions" do
    ...
    assert_raise ArgumentError,
                 ...
                 fn ->
                   ExGuten.new()
                   |> ExGuten.register_otf_font("DemoOTFBitmapOnlyEmbedding", path,
                     enforce_embedding_permissions: true
                   )
                 end
  ...
  test "register_otf_font/4 enforcement reports combined OS/2 bitmap-only and no-subsetting flags" do
    ...
    assert_raise ArgumentError,
                 ...
                 fn ->
                   ExGuten.new()
                   |> ExGuten.register_otf_font("DemoOTFCombinedFlagsEmbedding", path,
                     subset: :used_text,
                     enforce_embedding_permissions: true
                   )
                 end
  ...
  test "register_otf_font/3 warns on restricted OS/2 embedding permissions when enforcement is disabled" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_otf_font("DemoOTFRestrictedWarn", path)
      end)
  ...
  test "register_otf_font/4 warns on OS/2 no-subsetting permissions when enforcement is disabled" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_otf_font("DemoOTFNoSubsetWarn", path, subset: :used_text)
      end)
  ...
  test "register_otf_font/3 warns on OS/2 bitmap-only embedding permissions when enforcement is disabled" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_otf_font("DemoOTFBitmapOnlyWarn", path)
      end)
  ...
  test "register_otf_font/4 warning reports combined OS/2 bitmap-only and no-subsetting flags" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_otf_font("DemoOTFCombinedFlagsWarn", path, subset: :used_text)
      end)
  ...
  test "register_ttf_font/3 emits descriptor AvgWidth from parsed OS/2 metadata" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoAvgWidth", path)
      |> ExGuten.set_font("DemoAvgWidth", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor MaxWidth from parsed hmtx metrics" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoMaxWidth", path)
      |> ExGuten.set_font("DemoMaxWidth", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 prefers descriptor MaxWidth from parsed hhea advanceWidthMax" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoHheaMaxWidth", path)
      |> ExGuten.set_font("DemoHheaMaxWidth", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor MissingWidth from glyph 0 advance width" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoMissingWidth", path)
      |> ExGuten.set_font("DemoMissingWidth", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 prefers descriptor MissingWidth from OS/2 default char glyph" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoDefaultCharMissingWidth", path)
      |> ExGuten.set_font("DemoDefaultCharMissingWidth", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 falls back MissingWidth to OS/2 break char glyph when default char is unmapped" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoBreakCharMissingWidth", path)
      |> ExGuten.set_font("DemoBreakCharMissingWidth", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed OS/2 first/last char indexes for non-subset char range" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoOS2CharRange", path)
      |> ExGuten.set_font("DemoOS2CharRange", 14)
      |> ExGuten.text_at(50, 700, "AB")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor italic angle and italic flag from parsed metrics" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoItalicMetrics", path)
      |> ExGuten.set_font("DemoItalicMetrics", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor fixed-pitch flag from parsed post metrics" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoFixedPitchMetrics", path)
      |> ExGuten.set_font("DemoFixedPitchMetrics", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor force-bold flag from parsed head macStyle" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoForceBoldMetrics", path)
      |> ExGuten.set_font("DemoForceBoldMetrics", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor FontFamily from parsed name table" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoFamilyName", path)
      |> ExGuten.set_font("DemoFamilyName", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontFamily from parsed CFF metadata when name table is unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFFamilyName", path)
      |> ExGuten.set_font("DemoCFFFamilyName", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontFamily from parsed CFF standard SID family metadata when name table is unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFStandardSIDFamilyName", path)
      |> ExGuten.set_font("DemoCFFStandardSIDFamilyName", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontFamily from CFF FullName fallback when FamilyName and name table are unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFFullNameFamily", path)
      |> ExGuten.set_font("DemoCFFFullNameFamily", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits descriptor FontFamily from CFF FontName fallback when FamilyName, FullName, and name table are unavailable" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoCFFFontNameFamily", path)
      |> ExGuten.set_font("DemoCFFFontNameFamily", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor style flags from OS/2 fsSelection bits" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoOS2SelectionStyle", path)
      |> ExGuten.set_font("DemoOS2SelectionStyle", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits italic descriptor style flags from OS/2 fsSelection oblique bit" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoOS2ObliqueSelectionStyle", path)
      |> ExGuten.set_font("DemoOS2ObliqueSelectionStyle", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits descriptor Style Panose from parsed OS/2 metadata" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoPanoseStyle", path)
      |> ExGuten.set_font("DemoPanoseStyle", 14)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits Type0/CID font objects for unicode text runs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeType0", path)
      |> ExGuten.set_font("DemoUnicodeType0", 12)
      |> ExGuten.text_at(50, 700, "Snowman ☃")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits ToUnicode cmap for Type0 unicode fonts" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeToUnicode", path)
      |> ExGuten.set_font("DemoUnicodeToUnicode", 12)
      |> ExGuten.text_at(50, 700, "Snowman ☃")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits CID width arrays for Type0 unicode fonts" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeCIDWidths", path)
      |> ExGuten.set_font("DemoUnicodeCIDWidths", 12)
      |> ExGuten.text_at(50, 700, "AB☃")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits CIDToGIDMap stream for Type0 unicode fonts using cmap glyph IDs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeCIDToGIDMap", path)
      |> ExGuten.set_font("DemoUnicodeCIDToGIDMap", 12)
      |> ExGuten.text_at(50, 700, "☃★")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 handles non-BMP unicode in Type0 ToUnicode and CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeNonBMP", path)
      |> ExGuten.set_font("DemoUnicodeNonBMP", 12)
      |> ExGuten.text_at(50, 700, "😀")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 maps non-BMP surrogate CIDs in CIDToGIDMap from format-12 cmap data" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeNonBMPCIDToGID", path)
      |> ExGuten.set_font("DemoUnicodeNonBMPCIDToGID", 12)
      |> ExGuten.text_at(50, 700, "😀")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 falls back to CIDToGIDMap /Identity when non-BMP surrogate CIDs are ambiguous" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeNonBMPCIDToGIDAmbiguous", path)
      |> ExGuten.set_font("DemoUnicodeNonBMPCIDToGIDAmbiguous", 12)
      |> ExGuten.text_at(50, 700, "😀😁")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 falls back to base CID widths when non-BMP surrogate widths are ambiguous" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeNonBMPWidthsAmbiguous", path)
      |> ExGuten.set_font("DemoUnicodeNonBMPWidthsAmbiguous", 12)
      |> ExGuten.text_at(50, 700, "😀😁")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 logs warnings when non-BMP surrogate ambiguity triggers Type0 fallbacks" do
    ...
    log =
      capture_log(fn ->
        ExGuten.new()
        |> ExGuten.register_ttf_font("DemoUnicodeNonBMPAmbiguousWarnings", path)
        |> ExGuten.set_font("DemoUnicodeNonBMPAmbiguousWarnings", 12)
        |> ExGuten.text_at(50, 700, "😀😁")
        |> ExGuten.export()
      end)
  ...
  test "register_ttf_font/3 compacts ToUnicode contiguous mappings into bfrange" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeToUnicodeCompact", path)
      |> ExGuten.set_font("DemoUnicodeToUnicodeCompact", 12)
      |> ExGuten.text_at(50, 700, "ABC☃")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 compacts contiguous CID widths into range form" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeCIDCompact", path)
      |> ExGuten.set_font("DemoUnicodeCIDCompact", 12)
      |> ExGuten.text_at(50, 700, "☃☄★")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed cmap format 4 mappings for unicode CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat4", path)
      |> ExGuten.set_font("DemoUnicodeFormat4", 12)
      |> ExGuten.text_at(50, 700, "☃★")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed cmap format 6 mappings for unicode CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat6", path)
      |> ExGuten.set_font("DemoUnicodeFormat6", 12)
      |> ExGuten.text_at(50, 700, "☃☄")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed cmap format 12 mappings for non-BMP CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat12", path)
      |> ExGuten.set_font("DemoUnicodeFormat12", 12)
      |> ExGuten.text_at(50, 700, "😀")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed cmap format 13 mappings for unicode CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat13", path)
      |> ExGuten.set_font("DemoUnicodeFormat13", 12)
      |> ExGuten.text_at(50, 700, "☃☄★")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed cmap format 10 mappings for unicode CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat10", path)
      |> ExGuten.set_font("DemoUnicodeFormat10", 12)
      |> ExGuten.text_at(50, 700, "☃☄")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed cmap format 2 mappings for unicode CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat2", path)
      |> ExGuten.set_font("DemoUnicodeFormat2", 12)
      |> ExGuten.text_at(50, 700, "☃☄")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 uses parsed cmap format 8 mappings for unicode CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat8", path)
      |> ExGuten.set_font("DemoUnicodeFormat8", 12)
      |> ExGuten.text_at(50, 700, "☃☄")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 stores parsed cmap format 14 variation metadata" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat14", path)
  ...
  test "register_ttf_font/3 applies format-14 variation mapping to Type0 CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat4And14Widths", path)
      |> ExGuten.set_font("DemoUnicodeFormat4And14Widths", 12)
      |> ExGuten.text_at(50, 700, "☃️")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 applies format-14 variation mapping to Type0 CIDToGIDMap" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeFormat4And14CIDToGID", path)
      |> ExGuten.set_font("DemoUnicodeFormat4And14CIDToGID", 12)
      |> ExGuten.text_at(50, 700, "☃️")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits CIDToGID zero mapping for unmapped ZWJ codepoints" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeZWJCIDToGID", path)
      |> ExGuten.set_font("DemoUnicodeZWJCIDToGID", 12)
      |> ExGuten.text_at(50, 700, "☃‍★")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits CIDToGID zero mapping for unmapped combining marks" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeCombiningCIDToGID", path)
      |> ExGuten.set_font("DemoUnicodeCombiningCIDToGID", 12)
      |> ExGuten.text_at(50, 700, "Á")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits zero CID width for unmapped ZWJ codepoints in Type0 widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeZWJWidth", path)
      |> ExGuten.set_font("DemoUnicodeZWJWidth", 12)
      |> ExGuten.text_at(50, 700, "☃‍★")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits zero CID width for unmapped combining marks in Type0 widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeCombiningWidth", path)
      |> ExGuten.set_font("DemoUnicodeCombiningWidth", 12)
      |> ExGuten.text_at(50, 700, "Á")
      |> ExGuten.export()
  ...
  test "register_ttf_font/3 emits zero CID width for unmapped script-specific combining marks in Type0 widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_ttf_font("DemoUnicodeScriptCombiningWidth", path)
      |> ExGuten.set_font("DemoUnicodeScriptCombiningWidth", 12)
      |> ExGuten.text_at(50, 700, "Aְ")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 emits Type0/CID font objects for unicode text runs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFUnicodeType0", path)
      |> ExGuten.set_font("DemoOTFUnicodeType0", 12)
      |> ExGuten.text_at(50, 700, "☃")
      |> ExGuten.export()
  ...
  test "register_otf_font/4 used-text subset uses Type0/CID objects for non-ASCII text runs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFUnicodeSubsetType0", path, subset: :used_text)
      |> ExGuten.set_font("DemoOTFUnicodeSubsetType0", 12)
      |> ExGuten.text_at(50, 700, "☃")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 handles non-BMP unicode in Type0 ToUnicode and CID widths" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFUnicodeNonBMP", path)
      |> ExGuten.set_font("DemoOTFUnicodeNonBMP", 12)
      |> ExGuten.text_at(50, 700, "😀")
      |> ExGuten.export()
  ...
  test "register_otf_font/3 embeds an OpenType font stream and allows set_font/3" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTF", path)
      |> ExGuten.set_font("DemoOTF", 12)
      |> ExGuten.text_at(50, 700, "Hello OTF")
      |> ExGuten.export()
  ...
  test "register_otf_font/4 uses parsed sfnt widths for used-text subset ranges when tables exist" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFMetrics", path, subset: :used_text)
      |> ExGuten.set_font("DemoOTFMetrics", 12)
      |> ExGuten.text_at(50, 700, "AB")
      |> ExGuten.export()
  ...
  test "register_otf_font/4 used-text subset shrinks CFF charstrings for unused glyphs" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFCFFSubset", path, subset: :used_text)
      |> ExGuten.set_font("DemoOTFCFFSubset", 12)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/4 used-text subset shrinks CFF charstrings when unreferenced bytes trail CharStrings" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFCFFSubsetTail", path, subset: :used_text)
      |> ExGuten.set_font("DemoOTFCFFSubsetTail", 12)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/4 used-text subset shrinks CFF charstrings when Top DICT includes real-number operands" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFCFFSubsetRealTopDict", path, subset: :used_text)
      |> ExGuten.set_font("DemoOTFCFFSubsetRealTopDict", 12)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/4 used-text subset updates referenced CFF Private offsets when CharStrings shrink" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFCFFSubsetPrivateTail", path, subset: :used_text)
      |> ExGuten.set_font("DemoOTFCFFSubsetPrivateTail", 12)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_otf_font/4 used-text subset updates FDArray Font DICT private offsets when CharStrings shrink" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.register_otf_font("DemoOTFCFFSubsetFDArrayPrivateTail", path, subset: :used_text)
      |> ExGuten.set_font("DemoOTFCFFSubsetFDArrayPrivateTail", 12)
      |> ExGuten.text_at(50, 700, "A")
      |> ExGuten.export()
  ...
  test "register_ttf_font/4 and register_otf_font/4 reject invalid subset options" do
    ...
    assert_raise ArgumentError, "subset must be :none, :ascii_basic, or :used_text", fn ->
      ExGuten.new()
      |> ExGuten.register_ttf_font("BadSubsetTTF", ttf_path, subset: :full)
    end

    assert_raise ArgumentError, "subset must be :none, :ascii_basic, or :used_text", fn ->
      ExGuten.new()
      |> ExGuten.register_otf_font("BadSubsetOTF", otf_path, subset: :full)
    end
  ...
  test "register_ttf_font/4 rejects non-boolean enforce_embedding_permissions option values" do
    ...
    assert_raise ArgumentError, "enforce_embedding_permissions must be a boolean", fn ->
      ExGuten.new()
      |> ExGuten.register_ttf_font("BadEnforcementOption", path,
  ...
  test "register_ttf_font/3 rejects invalid TTF payloads" do
    ...
    assert_raise ArgumentError, "invalid TTF file: #{path}", fn ->
      ExGuten.new()
      |> ExGuten.register_ttf_font("BadTTF", path)
    end
  ...
  test "register_ttf_font/3 rejects TTF payloads missing required metric tables" do
    ...
    assert_raise ArgumentError, "invalid TTF file: #{path}", fn ->
      ExGuten.new()
      |> ExGuten.register_ttf_font("BadTTFTables", path)
    end
  ...
  test "register_otf_font/3 rejects invalid OTF payloads" do
    ...
    assert_raise ArgumentError, "invalid OTF file: #{path}", fn ->
      ExGuten.new()
      |> ExGuten.register_otf_font("BadOTF", path)
    end
  ...
  test "register_ttf_font/3 and register_otf_font/3 reject unreadable files" do
    ...
    assert_raise ArgumentError, "unable to read TTF file: #{missing_ttf}", fn ->
      ExGuten.new()
      |> ExGuten.register_ttf_font("MissingTTF", missing_ttf)
    end

    assert_raise ArgumentError, "unable to read OTF file: #{missing_otf}", fn ->
      ExGuten.new()
      |> ExGuten.register_otf_font("MissingOTF", missing_otf)
    end
  end
  ...
  test "set_font/3 rejects unknown fonts" do
    assert_raise ArgumentError, fn ->
      ExGuten.new()
      |> ExGuten.set_font("Unknown-Font", 12)
    end
  end
  ...
  test "text_at_with_fallback/5 splits text runs across embedded fallback fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackSnowman", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "A☃B", ["FallbackSnowman"])
  ...
  test "text_at_with_fallback/5 keeps a single run when primary supports all glyphs" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackSnowman", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "AB", ["FallbackSnowman"])
  ...
  test "text_at_with_fallback/5 treats unmapped ZWJ as zero-width with built-in primary fonts" do
    ...
    expected_x2 = 50.0 + ExGuten.Font.text_width("Helvetica", 12, "AB")
  ...
  test "text_at_with_fallback/5 treats unmapped combining marks as zero-width for cursor advancement" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackSnowman", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "ÁB☃", ["FallbackSnowman"])
  ...
  test "text_at_with_fallback/5 treats unmapped script-specific combining marks as zero-width for cursor advancement" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackSnowman", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AְB☃", ["FallbackSnowman"])
  ...
  test "text_at_with_fallback/5 prefers fallback font for ZWJ sequences when primary lacks base glyphs" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackSymbols", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "☃‍★", ["FallbackSymbols"])
  ...
  test "text_at_with_fallback/5 preserves current font after drawing fallback runs" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackSnowman", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "A☃", ["FallbackSnowman"])
  ...
  test "text_at_rotated_with_fallback/6 preserves current font after drawing fallback runs" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackSnowman", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_rotated_with_fallback(10, 600, 30, "A☃", ["FallbackSnowman"])
  ...
  test "text_at_with_fallback/6 preserves current font when shaping uses fallback glyphs" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("FallbackLigatureFI", ligature_path)
      |> ExGuten.set_font("Helvetica", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "fi", ["FallbackLigatureFI"],
  ...
  test "text_at_with_fallback/5 keeps variation-selector graphemes in a single fallback run and advances by variation width" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackSnowmanVariation", fallback_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "A☃️B", ["FallbackSnowmanVariation"])
  ...
  test "text_at_with_fallback/5 prefers fonts with format-14 variation mappings over base-only glyph coverage" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimarySnowmanBaseOnly", primary_path)
      |> ExGuten.register_ttf_font("FallbackSnowmanVariation", fallback_path)
      |> ExGuten.set_font("PrimarySnowmanBaseOnly", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "☃️", ["FallbackSnowmanVariation"])
  ...
  test "text_at_with_fallback/5 uses OS/2 unicode ranges when embedded cmap is unavailable" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryGreekNoCmap", primary_path)
      |> ExGuten.register_ttf_font("FallbackASCII", fallback_path)
      |> ExGuten.set_font("PrimaryGreekNoCmap", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "A", ["FallbackASCII"])
  ...
  test "text_at_with_fallback/5 keeps permissive fallback when embedded cmap and unicode ranges are unavailable" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryNoCmapUnknownRanges", primary_path)
      |> ExGuten.register_ttf_font("FallbackASCII", fallback_path)
      |> ExGuten.set_font("PrimaryNoCmapUnknownRanges", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "A", ["FallbackASCII"])
  ...
  test "text_at_with_fallback/5 uses OS/2 code page ranges when cmap and unicode ranges are unavailable" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryCyrillicNoCmap", primary_path)
      |> ExGuten.register_ttf_font("FallbackLatin1EAcute", fallback_path)
      |> ExGuten.set_font("PrimaryCyrillicNoCmap", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "é", ["FallbackLatin1EAcute"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Cyrillic code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryCyrillicNoCmap", primary_path)
      |> ExGuten.register_ttf_font("FallbackCyrillicZh", fallback_path)
      |> ExGuten.set_font("PrimaryCyrillicNoCmap", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "Ж", ["FallbackCyrillicZh"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Greek code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryGreekNoCmapCodePage", primary_path)
      |> ExGuten.register_ttf_font("FallbackGreekOmega", fallback_path)
      |> ExGuten.set_font("PrimaryGreekNoCmapCodePage", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "Ω", ["FallbackGreekOmega"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Turkish code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryTurkishNoCmapCodePage", primary_path)
      |> ExGuten.register_ttf_font("FallbackTurkishGBreve", fallback_path)
      |> ExGuten.set_font("PrimaryTurkishNoCmapCodePage", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "ğ", ["FallbackTurkishGBreve"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Baltic code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryBalticNoCmapCodePage", primary_path)
      |> ExGuten.register_ttf_font("FallbackBalticGCedilla", fallback_path)
      |> ExGuten.set_font("PrimaryBalticNoCmapCodePage", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "Ģ", ["FallbackBalticGCedilla"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Vietnamese code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryVietnameseNoCmapCodePage", primary_path)
      |> ExGuten.register_ttf_font("FallbackVietnameseOHorn", fallback_path)
      |> ExGuten.set_font("PrimaryVietnameseNoCmapCodePage", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "ơ", ["FallbackVietnameseOHorn"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Hebrew code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryHebrewNoCmapCodePage", primary_path)
      |> ExGuten.register_ttf_font("FallbackHebrewAlef", fallback_path)
      |> ExGuten.set_font("PrimaryHebrewNoCmapCodePage", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "א", ["FallbackHebrewAlef"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Arabic code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryArabicNoCmapCodePage", primary_path)
      |> ExGuten.register_ttf_font("FallbackArabicAlef", fallback_path)
      |> ExGuten.set_font("PrimaryArabicNoCmapCodePage", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "ا", ["FallbackArabicAlef"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Thai code page for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryThaiNoCmapCodePage", primary_path)
      |> ExGuten.register_ttf_font("FallbackThaiKoKai", fallback_path)
      |> ExGuten.set_font("PrimaryThaiNoCmapCodePage", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "ก", ["FallbackThaiKoKai"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Cyrillic unicode range for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryCyrillicNoCmapUnicodeRange", primary_path)
      |> ExGuten.register_ttf_font("FallbackCyrillicZh", fallback_path)
      |> ExGuten.set_font("PrimaryCyrillicNoCmapUnicodeRange", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "Ж", ["FallbackCyrillicZh"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Hebrew unicode range for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryHebrewNoCmapUnicodeRange", primary_path)
      |> ExGuten.register_ttf_font("FallbackHebrewAlef", fallback_path)
      |> ExGuten.set_font("PrimaryHebrewNoCmapUnicodeRange", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "א", ["FallbackHebrewAlef"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Arabic unicode range for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryArabicNoCmapUnicodeRange", primary_path)
      |> ExGuten.register_ttf_font("FallbackArabicAlef", fallback_path)
      |> ExGuten.set_font("PrimaryArabicNoCmapUnicodeRange", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "ا", ["FallbackArabicAlef"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Armenian unicode range for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryArmenianNoCmapUnicodeRange", primary_path)
      |> ExGuten.register_ttf_font("FallbackArmenianAyb", fallback_path)
      |> ExGuten.set_font("PrimaryArmenianNoCmapUnicodeRange", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "Ա", ["FallbackArmenianAyb"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Devanagari unicode range for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryDevanagariNoCmapUnicodeRange", primary_path)
      |> ExGuten.register_ttf_font("FallbackDevanagariA", fallback_path)
      |> ExGuten.set_font("PrimaryDevanagariNoCmapUnicodeRange", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "अ", ["FallbackDevanagariA"])
  ...
  test "text_at_with_fallback/5 uses OS/2 Thai unicode range for cmap-less embedded fonts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryThaiNoCmapUnicodeRange", primary_path)
      |> ExGuten.register_ttf_font("FallbackThaiKoKai", fallback_path)
      |> ExGuten.set_font("PrimaryThaiNoCmapUnicodeRange", 12)
      |> ExGuten.text_at_with_fallback(10, 600, "ก", ["FallbackThaiKoKai"])
  ...
  test "text_at_with_fallback/6 skips latin ligature shaping when fallback GSUB lacks liga feature" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureFINoLiga", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "fi", ["FallbackLigatureFINoLiga"],
        shaping: :latin_ligatures
      )
  ...
  test "text_at_with_fallback/6 skips latin ligature shaping when fallback GSUB lacks latn script" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureFINoLatn", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "fi", ["FallbackLigatureFINoLatn"],
        shaping: :latin_ligatures
      )
  ...
  test "text_at_with_fallback/6 respects OS/2 max context limits for latin ligature shaping" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureFIRestricted", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "fi", ["FallbackLigatureFIRestricted"],
        shaping: :latin_ligatures
      )
  ...
  test "text_at_with_fallback/6 applies GSUB lookup-defined latin ligatures" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureST", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "st", ["FallbackLigatureST"],
        shaping: :latin_ligatures
      )
  ...
  test "text_at_with_fallback/6 applies GSUB lookup-defined single substitutions" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("SingleSubAToB", single_sub_path)
      |> ExGuten.set_font("SingleSubAToB", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "A", [], shaping: :gsub_ligatures)
  ...
  test "text_at_with_fallback/6 applies GSUB rlig single substitutions with shaping: :gsub_ligatures" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("SingleSubAToBRlig", single_sub_path)
      |> ExGuten.set_font("SingleSubAToBRlig", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "A", [], shaping: :gsub_ligatures)
  ...
  test "text_at_with_fallback/6 skips GSUB ligature when liga feature does not link the lookup" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureSTNoLigaLookup", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "st", ["FallbackLigatureSTNoLigaLookup"],
        shaping: :latin_ligatures
      )
  ...
  test "text_at_with_fallback/6 prefers default GSUB LangSys over named LangSys for liga lookups" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureSTDefaultLangSys", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "st", ["FallbackLigatureSTDefaultLangSys"],
        shaping: :latin_ligatures
      )
  ...
  test "text_at_with_fallback/5 applies embedded GPOS kerning to segment advance widths" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAV", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAV"])
  ...
  test "text_at_with_fallback/6 applies opt-in embedded GPOS kerning to rendered fallback glyph positions" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackKerningAV", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAV"], kerning: :gpos)
  ...
  test "text_at_rotated_with_fallback/7 applies opt-in embedded GPOS kerning to rendered fallback glyph positions" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackKerningAV", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_rotated_with_fallback(50, 700, 20, "AVX", ["FallbackKerningAV"],
        kerning: :gpos
      )
  ...
  test "text_at_with_fallback/5 applies embedded GPOS ValueRecord2 kerning to segment advance widths" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAVValue2", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAVValue2"])
  ...
  test "text_at_with_fallback/5 skips malformed embedded GPOS pair-kerning subtables when coverage count mismatches pair-set count" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAVCoverageMismatch", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAVCoverageMismatch"])
  ...
  test "text_at_with_fallback/5 skips oversized embedded GPOS pair-set value records" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAVOversized", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAVOversized"])
  ...
  test "text_at_with_fallback/5 ignores malformed embedded GPOS pair-set with truncated pair-value records" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAVTruncated", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAVTruncated"])
  ...
  test "text_at_with_fallback/5 applies embedded GPOS kerning across zero-advance combining marks" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningACombiningV", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "A\u0301VX", ["FallbackKerningACombiningV"])
  ...
  test "text_at_with_fallback/5 applies embedded GPOS class kerning from format-2 lookups" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackClassKerningAVX", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackClassKerningAVX"])
  ...
  test "text_at_with_fallback/5 skips oversized embedded GPOS class kerning matrices" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackClassKerningAVXOversized", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackClassKerningAVXOversized"])
  ...
  test "text_at_with_fallback/5 skips malformed embedded GPOS class pair-kerning subtables with invalid class counts" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackClassKerningAVXInvalidClassCounts", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(
        50,
        700,
        "AVX",
  ...
  test "text_at_with_fallback/5 skips malformed embedded GPOS class pair-kerning subtables with truncated class-adjustment records" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackClassKerningAVXTruncatedRecords", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(
        50,
        700,
  ...
  test "text_at_with_fallback/5 skips malformed embedded GPOS class pair-kerning subtables with invalid class-definition offsets" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackClassKerningAVXInvalidClassDefOffsets", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(
        50,
        700,
  ...
  test "text_at_with_fallback/5 skips oversized expanded embedded GPOS class kerning mappings" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackClassKerningAVXExpansionOversized", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", [
  ...
  test "text_at_with_fallback/5 skips oversized embedded GPOS class-definition expansions" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackClassKerningAVXClassDefOversized", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(
        50,
        700,
  ...
  test "text_at_with_fallback/5 skips embedded GPOS kerning when kern feature does not link lookup" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAVNoKernLookup", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAVNoKernLookup"])
  ...
  test "text_at_with_fallback/5 prefers default GPOS LangSys over named LangSys for kern lookups" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAVDefaultLangSys", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAVDefaultLangSys"])
  ...
  test "text_at_with_fallback/6 prefers latn script over arab script for GSUB liga lookups" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureSTArabOnly", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "st", ["FallbackLigatureSTArabOnly"],
        shaping: :latin_ligatures
      )
  ...
  test "text_at_with_fallback/6 applies GPOS kerning after GSUB ligature shaping when both modes are enabled" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
      |> ExGuten.register_ttf_font("FallbackLigatureSTKerningX", ligature_kerning_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "st★", ["FallbackLigatureSTKerningX"],
        shaping: :gsub_ligatures,
        kerning: :gpos
      )
  ...
  test "text_at_rotated_with_fallback/7 applies GPOS kerning after GSUB ligature shaping when both modes are enabled" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackLigatureSTKerningX", ligature_kerning_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_rotated_with_fallback(50, 700, 20, "st★", ["FallbackLigatureSTKerningX"],
        shaping: :gsub_ligatures,
        kerning: :gpos
      )
  ...
  test "text_at_rotated_with_fallback/7 applies GSUB ligatures across non-latin scripts with shaping: :gsub_ligatures" do
    ...
    pdf =
      ...
      |> ExGuten.register_ttf_font("FallbackLigatureSTArabOnly", ligature_path)
      |> ExGuten.set_font("PrimaryASCII", 12)
      |> ExGuten.text_at_rotated_with_fallback(50, 700, 20, "st", ["FallbackLigatureSTArabOnly"],
        shaping: :gsub_ligatures
      )
  ...
  test "text_at_with_fallback/5 prefers latn script over arab script for GPOS kern lookups" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.register_ttf_font("FallbackKerningAVArabOnly", kerning_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", ["FallbackKerningAVArabOnly"])
  ...
  test "text_at_with_fallback/6 rejects invalid shaping option" do
    ...
    assert_raise ArgumentError,
                 ...
                 fn ->
                   ...
                   |> ExGuten.register_ttf_font("PrimaryASCII", primary_path)
                   |> ExGuten.set_font("PrimaryASCII", 12)
                   |> ExGuten.text_at_with_fallback(50, 700, "fi", [], shaping: :full)
                 end
  ...
  test "text_at_with_fallback/6 rejects invalid kerning option" do
    ...
    assert_raise ArgumentError, "kerning option must be :off or :gpos", fn ->
      ...
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_with_fallback(50, 700, "AVX", [], kerning: :full)
    end
  ...
  test "text_at_rotated_with_fallback/7 rejects invalid kerning option" do
    ...
    assert_raise ArgumentError, "kerning option must be :off or :gpos", fn ->
      ...
      |> ExGuten.register_ttf_font("PrimaryX", primary_path)
      |> ExGuten.set_font("PrimaryX", 12)
      |> ExGuten.text_at_rotated_with_fallback(50, 700, 20, "AVX", [], kerning: :full)
    end
  ...
  test "add_bookmark/3 serializes outlines and destinations" do
    pdf_binary =
      ...
      |> ExGuten.add_page()
      |> ExGuten.text_at(10, 700, "page two")
      |> ExGuten.add_bookmark("Start", 1)
      |> ExGuten.add_bookmark("Second", 2)
      |> ExGuten.export()
  ...
  test "add_bookmark/3 rejects unknown page numbers" do
    assert_raise ArgumentError, "unknown page: 2", fn ->
      ExGuten.new()
      |> ExGuten.add_bookmark("Missing", 2)
    end
  end
  ...
  test "image_jpeg/6 embeds image object and paints it with a transform matrix" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.image_jpeg(72, 500, 144, 96, path)
      |> ExGuten.export()
  ...
  test "image_png/6 embeds RGBA PNG with an SMask alpha image" do
    ...
    pdf_binary =
      ExGuten.new()
      |> ExGuten.image_png(50, 600, 32, 32, path)
      |> ExGuten.export()
  ...
  test "image_jpeg/6 rejects invalid JPEG payloads" do
    ...
    assert_raise ArgumentError, "invalid JPEG file: #{path}", fn ->
      ExGuten.new()
      |> ExGuten.image_jpeg(0, 0, 10, 10, path)
    end
  ...
  test "image_png/6 rejects invalid PNG payloads" do
    ...
    assert_raise ArgumentError, "invalid PNG file: #{path}", fn ->
      ExGuten.new()
      |> ExGuten.image_png(0, 0, 10, 10, path)
    end
  ...
  test "image_jpeg/6 and image_png/6 reject unreadable files" do
    ...
    assert_raise ArgumentError, "unable to read JPEG file: #{missing_jpg}", fn ->
      ExGuten.new()
      |> ExGuten.image_jpeg(0, 0, 10, 10, missing_jpg)
    end

    assert_raise ArgumentError, "unable to read PNG file: #{missing_png}", fn ->
      ExGuten.new()
      |> ExGuten.image_png(0, 0, 10, 10, missing_png)
    end
  end
  ...
  test "export/1 writes text stream and font resources" do
    pdf_binary =
      ExGuten.new()
      |> ExGuten.set_font("Times-Roman", 16)
      |> ExGuten.text_at(50, 700, "Hello (PDF)")
      |> ExGuten.export()
  ...
  test "export/1 maps multiple fonts to distinct font resources" do
    pdf_binary =
      ...
      |> ExGuten.set_font("Helvetica", 12)
      |> ExGuten.text_at(50, 700, "Hello")
      |> ExGuten.set_font("Times-Roman", 10)
      |> ExGuten.text_at(50, 680, "World")
      |> ExGuten.export()
  ...
  test "export/1 encodes unicode metadata and bookmark titles as UTF-16BE hex strings" do
    pdf_binary =
      ExGuten.new()
      |> ExGuten.text_at(10, 700, "page one")
      |> ExGuten.set_metadata(title: "你好世界")
      |> ExGuten.add_bookmark("Résumé", 1)
      |> ExGuten.export()
  ...
  test "rectangle/5 appends draw operations and exports rectangle commands" do
    pdf =
      ExGuten.new()
      |> ExGuten.rectangle(20, 600, 120, 40)
  ...
  test "set_stroke_color/2 and set_fill_color/2 export rgb color operators" do
    pdf_binary =
      ExGuten.new()
      |> ExGuten.set_stroke_color({1, 0, 0})
      |> ExGuten.set_fill_color({0, 1, 0})
      |> ExGuten.export()
  ...
  test "path ops export move/line/bezier and stroke commands" do
    pdf =
      ExGuten.new()
      |> ExGuten.move_to(10, 10)
      |> ExGuten.line_to(40, 10)
      |> ExGuten.bezier(50, 10, 50, 40, 40, 40)
      |> ExGuten.stroke()
  ...
  test "save_state/1 and restore_state/1 export q/Q operators" do
    pdf_binary =
      ExGuten.new()
      |> ExGuten.save_state()
      |> ExGuten.set_stroke_color({0, 0, 1})
  ...
  test "fill/1 and clip/1 export f and W n operators" do
    pdf =
      ...
      |> ExGuten.move_to(10, 10)
      |> ExGuten.line_to(40, 10)
      |> ExGuten.line_to(40, 40)
      |> ExGuten.fill()
      |> ExGuten.move_to(50, 50)
      |> ExGuten.line_to(80, 50)
      |> ExGuten.line_to(80, 80)
      |> ExGuten.clip()
  ...
  test "text_paragraph/6 renders wrapped text lines at positioned coordinates" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.text_paragraph(50, 700, rich, 30, line_height: 14)
  ...
  test "text_paragraph/6 renders justified gaps by x positioning words" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.text_paragraph(50, 700, rich, 60, align: :justified)
  ...
  test "text_paragraph/6 supports rotate option for laid-out words" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.text_paragraph(50, 700, rich, 30, line_height: 14, rotate: 45)
  ...
  test "text_paragraph/6 splits mixed-glyph words with fallback_fonts option" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("FallbackSnowman", fallback_path)
      |> ExGuten.text_paragraph(50, 700, rich, 300, fallback_fonts: ["FallbackSnowman"])
  ...
  test "text_paragraph/6 advances cursor by rendered fallback word width for subsequent words" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("FallbackSnowmanWide", fallback_path)
      |> ExGuten.text_paragraph(50, 700, rich, 300, fallback_fonts: ["FallbackSnowmanWide"])
    ...
    expected_x_c =
      x_b +
        ExGuten.Font.text_width("Helvetica", 12, "B") +
        ExGuten.Font.text_width("Helvetica", 12, " ")
  ...
  test "text_paragraph/6 rotate mode advances cursor by rendered fallback word width for subsequent words" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("FallbackSnowmanWide", fallback_path)
      |> ExGuten.text_paragraph(50, 700, rich, 300,
  ...
  test "text_paragraph/6 keeps variation-selector graphemes in a single fallback run" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("FallbackSnowmanVariation", fallback_path)
      |> ExGuten.text_paragraph(50, 700, rich, 300, fallback_fonts: ["FallbackSnowmanVariation"])
  ...
  test "text_paragraph/6 applies opt-in embedded GPOS kerning to rendered fallback glyph positions" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.register_ttf_font("FallbackKerningSnowmanStar", kerning_path)
      |> ExGuten.text_paragraph(50, 700, rich, 300,
  ...
  test "text_paragraph/6 with bidi: :basic applies baseline RTL visual order" do
    ...
    pdf =
      ExGuten.new()
      |> ExGuten.text_paragraph(50, 700, rich, 300, bidi: :basic)
  ...
  test "text_paragraph/6 rejects invalid bidi option" do
    ...
    assert_raise ArgumentError, "bidi option must be :off or :basic", fn ->
      ExGuten.new()
      |> ExGuten.text_paragraph(50, 700, rich, 300, bidi: :full)
    end
  end
  ...
  test "text_paragraph/6 rejects invalid kerning option" do
    ...
    assert_raise ArgumentError, "kerning option must be :off or :gpos", fn ->
      ExGuten.new()
      |> ExGuten.text_paragraph(50, 700, rich, 300, kerning: :full)
    end
  end
  ...
  test "text_paragraph/6 rejects non-numeric rotate option" do
    ...
    assert_raise ArgumentError, "rotate option must be a number of degrees", fn ->
      ExGuten.new()
      |> ExGuten.text_paragraph(50, 700, rich, 60, rotate: :diagonal)
    end
  end
  ...
  test "text_at_rotated/5 emits rotated text matrix in content stream" do
    pdf =
      ExGuten.new()
      |> ExGuten.set_font("Times-Roman", 24)
      |> ExGuten.text_at_rotated(100, 200, 45, "Rotation")
  ...
  defp write_test_jpeg! do
    path = Path.join(System.tmp_dir!(), "ex_guten_test_#{System.unique_integer([:positive])}.jpg")
  ...
  defp write_test_png! do
    path = Path.join(System.tmp_dir!(), "ex_guten_test_#{System.unique_integer([:positive])}.png")
  ...
  defp write_test_ttf! do
    path = Path.join(System.tmp_dir!(), "ex_guten_test_#{System.unique_integer([:positive])}.ttf")
  ...
  defp write_test_otf! do
    path = Path.join(System.tmp_dir!(), "ex_guten_test_#{System.unique_integer([:positive])}.otf")
  ...
  defp write_test_binary!(ext, bytes) do
    path =
      Path.join(System.tmp_dir!(), "ex_guten_test_#{System.unique_integer([:positive])}#{ext}")

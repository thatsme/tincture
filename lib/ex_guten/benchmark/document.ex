defmodule ExGuten.Benchmark.Document do
  @moduledoc false
  ...
  defp run_paragraph_flow do
    ...
    Enum.reduce(1..3, ExGuten.new(), fn idx, pdf ->
      page_pdf = if idx == 1, do: pdf, else: ExGuten.add_page(pdf)

      ExGuten.text_paragraph(page_pdf, 50, 740, rich, 500,
        align: :justified,
        line_break: :greedy,
  ...
  defp run_table_heavy do
    ...
    Enum.reduce(1..5, ExGuten.new(), fn idx, pdf ->
      page_pdf = if idx == 1, do: pdf, else: ExGuten.add_page(pdf)

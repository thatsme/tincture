defmodule ExGuten.Typography.Hyphen do
  @moduledoc false
  ...
  defp load_rules(:en_gb) do
    rules_path = Application.app_dir(:ex_guten, "priv/hyphen_rules/eg_hyphen_rules_en_GB.erl")
    parse_rule_file(rules_path)
  end

  defp load_rules(:da_dk) do
    rules_path = Application.app_dir(:ex_guten, "priv/hyphen/hyph_da_DK.dic")
    parse_dic_file(rules_path)
  end

  defp load_rules(:fi_fi) do
    rules_path = Application.app_dir(:ex_guten, "priv/hyphen/hyph_fi_FI.dic")
    parse_dic_file(rules_path)
  end

  defp load_rules(:nb_no) do
    rules_path = Application.app_dir(:ex_guten, "priv/hyphen/hyph_nb_NO.dic")
    parse_dic_file(rules_path)
  end

  defp load_rules(:sv_se) do
    rules_path = Application.app_dir(:ex_guten, "priv/hyphen/hyph_sv_SE.dic")
    parse_dic_file(rules_path)
  end

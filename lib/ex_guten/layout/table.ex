defmodule ExGuten.Layout.Table do
  @moduledoc false
      ...
      |> Enum.reduce(pdf, fn {row, row_index}, acc_pdf ->
        ...
        {row_pdf, _cursor_x} =
          ...
          |> Enum.reduce({acc_pdf, x * 1.0}, fn {cell, col_index}, {row_acc_pdf, cursor_x} ->
            ...
            with_border =
              if border? do
                ExGuten.rectangle(row_acc_pdf, cursor_x, row_bottom, width, row_height)
              else
                row_acc_pdf
              end
            ...
            with_text =
              if cell_text == "" do
                ...
                with_border
                |> ExGuten.set_font(font_name, font_size)
                |> ExGuten.text_at(cursor_x + padding, text_y, cell_text)
              end

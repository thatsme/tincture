defmodule ExGuten.Showcase.Invoice do
  @moduledoc false

  alias ExGuten.Layout.Table
  alias ExGuten.Layout.Template.DocumentResult
  alias ExGuten.Layout.Template.RenderResult
  ...
  def build_document do
    ...
    try do
      pdf =
        ...
        |> ExGuten.add_page()
        |> ExGuten.add_bookmark("Invoice Summary", 1)
        |> ExGuten.add_bookmark("Terms and Remittance", 2)
        |> ExGuten.set_page(1)
        |> draw_header_footer(1, 2)
        |> ExGuten.image_png(48, 736, 20, 20, logo_path)
        |> ExGuten.set_font("Helvetica-Bold", 22)
        |> ExGuten.text_at(74, 736, "INVOICE")
        |> ExGuten.set_font("Helvetica", 10)
        |> ExGuten.text_at(48, 712, "Invoice # INV-2026-0042")
        |> ExGuten.text_at(48, 698, "Issue Date: 2026-02-20")
        |> ExGuten.text_at(48, 684, "Bill To: Northwind Components")
        |> ExGuten.text_at_rotated(438, 702, 20, "APPROVED")
      ...
      pdf =
        ExGuten.text_paragraph(pdf, 48, 446, terms_rich, 250,
          align: :justified,
          line_break: :optimal,
      ...
      pdf =
        ...
        |> ExGuten.set_font("Helvetica-Bold", 12)
        |> ExGuten.text_at(48, 708, "Remittance and Terms")
        |> ExGuten.set_font("Helvetica", 10)
        |> ExGuten.text_at(48, 690, "ACH: 021000021 / 123456789")
        |> ExGuten.text_at(48, 676, "Reference: INV-2026-0042")
        |> ExGuten.text_at(48, 650, "Please remit payment within 30 days of invoice date.")
        |> ExGuten.text_at(48, 636, "Questions: billing@acme.example or (800) 555-0142")
  ...
  defp draw_header_footer(pdf, page, total) do
    ...
    |> ExGuten.text_at(48, 758, "ACME Industrial Systems - Invoice #{page}/#{total}")
    |> ExGuten.set_font("Helvetica", 9)
    |> ExGuten.text_at(48, 30, "Confidential - Page #{page} of #{total}")
  end
  ...
  defp write_test_logo_png! do
    path =
      Path.join(
        System.tmp_dir!(),
        "ex_guten_invoice_logo_#{System.unique_integer([:positive])}.png"
      )
